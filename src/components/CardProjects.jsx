...
const CardProjects = (props) => {
  return (
    <div className="border-4 border-orange overflow-hidden relative group w-[80%] md:w-full mx-auto h-56 md:h-72">
      <img src={props.img} alt={props.url} className="w-full h-full" />
